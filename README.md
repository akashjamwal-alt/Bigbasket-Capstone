...
- `ai_log.md` — AI-assisted prompting log (both Part 1 and Part 4 prompts)
...
- `part4-python/` — Python/Pandas notebook
  - `analysis.ipynb` — cleaning, analysis, and cross-validation
...
See [`part4-python/analysis.ipynb`](./part4-python/analysis.ipynb) 
for the full cleaning, analysis, and cross-validation notebook.
